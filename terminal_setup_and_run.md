...
3. Run the command `./setup.sh YOUR_WATID SERVER_NUM` in your terminal, replacing the capital words with your own values. If permission to run setup.sh is denied, run the command 'chmod +x setup.sh' in your terminal
